...
version: alpha
name: DWC
description: "DWC design system, Light theme (the Dark theme is documented at /design.dark.md)."
colors:
  # Primary
  ...
  primary-text: "oklch(0.42 0.253545 263.526)"  # --dwc-color-primary-text
  on-primary-text: "oklch(0.99 0.0114095 263.526)"  # --dwc-color-on-primary-text
  primary-seed: "hsl( 223, 91%, 50% )"  # --dwc-color-primary-seed
  border-color-primary: "oklch(0.9 0.0304254 263.526)"  # --dwc-border-color-primary
  border-color-primary-emphasis: "oklch(0.708 0.0760636 263.526)"  # --dwc-border-color-primary-emphasis
  # Success
  ...
  success-text: "oklch(0.42 0.160042 158.404)"  # --dwc-color-success-text
  on-success-text: "oklch(0.99 0.00720187 158.404)"  # --dwc-color-on-success-text
  success-seed: "hsl( 153, 60%, 50% )"  # --dwc-color-success-seed
  border-color-success: "oklch(0.9 0.019205 158.404)"  # --dwc-border-color-success
  border-color-success-emphasis: "oklch(0.708 0.0480125 158.404)"  # --dwc-border-color-success-emphasis
  # Warning
  ...
  warning-text: "oklch(0.42 0.165227 64.8007)"  # --dwc-color-warning-text
  on-warning-text: "oklch(0.99 0.00743523 64.8007)"  # --dwc-color-on-warning-text
  warning-seed: "hsl( 35, 90%, 50% )"  # --dwc-color-warning-seed
  border-color-warning: "oklch(0.9 0.0198273 64.8007)"  # --dwc-border-color-warning
  border-color-warning-emphasis: "oklch(0.708 0.0495682 64.8007)"  # --dwc-border-color-warning-emphasis
  # Danger
  ...
  danger-text: "oklch(0.42 0.240641 29.7575)"  # --dwc-color-danger-text
  on-danger-text: "oklch(0.99 0.0108288 29.7575)"  # --dwc-color-on-danger-text
  danger-seed: "hsl( 4, 90%, 50% )"  # --dwc-color-danger-seed
  border-color-danger: "oklch(0.9 0.0288769 29.7575)"  # --dwc-border-color-danger
  border-color-danger-emphasis: "oklch(0.708 0.0721923 29.7575)"  # --dwc-border-color-danger-emphasis
  # Info
  ...
  info-text: "oklch(0.42 0.2306 292.014)"  # --dwc-color-info-text
  on-info-text: "oklch(0.99 0.010377 292.014)"  # --dwc-color-on-info-text
  info-seed: "hsl( 262, 65%, 50% )"  # --dwc-color-info-seed
  border-color-info: "oklch(0.9 0.027672 292.014)"  # --dwc-border-color-info
  border-color-info-emphasis: "oklch(0.708 0.0691799 292.014)"  # --dwc-border-color-info-emphasis
  # Gray
  gray: "oklch(0.08 0.00000566722 25.7195)"  # --dwc-color-gray
  gray-dark: "oklch(0.05 0.00000417585 26.0195)"  # --dwc-color-gray-dark
  gray-light: "oklch(0.11 0.0000071586 25.4195)"  # --dwc-color-gray-light
  gray-alt: "oklch(0.598177 0.0000298275 23.6195 / 0.12)"  # --dwc-color-gray-alt
  gray-text: "oklch(0.42 0.0000298275 23.6195)"  # --dwc-color-gray-text
  on-gray-text: "oklch(0.99 2.83361e-7 25.7195)"  # --dwc-color-on-gray-text
  gray-seed: "hsl( 0, 0%, 50% )"  # --dwc-color-gray-seed
  border-color-gray: "oklch(0.9 0.0000035793 23.6195)"  # --dwc-border-color-gray
  border-color-gray-emphasis: "oklch(0.708 0.00000894825 23.6195)"  # --dwc-border-color-gray-emphasis
  # Default
  default: "oklch(0.9 0.008 268.858)"  # --dwc-color-default
  default-dark: "oklch(0.86 0.008 268.858)"  # --dwc-color-default-dark
  default-light: "oklch(0.94 0.008 268.858)"  # --dwc-color-default-light
  default-alt: "oklch(0.510166 0.253545 263.526 / 0.12)"  # --dwc-color-default-alt
  default-text: "oklch(0.42 0.00867959 268.858)"  # --dwc-color-default-text
  on-default-text: "oklch(0.13 0.0028 268.858)"  # --dwc-color-on-default-text
  default-seed: "hsl( 223, 3%, 50% )"  # --dwc-color-default-seed
  border-color-default: "oklch(0.9 0.00104155 268.858)"  # --dwc-border-color-default
  border-color-default-emphasis: "oklch(0.708 0.00260388 268.858)"  # --dwc-border-color-default-emphasis
  # Surfaces
  surface-1: "oklch(0.96 0.004 268.858)"  # --dwc-surface-1
  surface-2: "oklch(0.975 0.004 268.858)"  # --dwc-surface-2
  surface-3: "oklch(0.99 0.004 268.858)"  # --dwc-surface-3
  # Globals
  black: "oklch(0.12 0.0130194 268.858)"  # --dwc-color-black
  white: "oklch(0.98 0.0130194 268.858)"  # --dwc-color-white
  body-text: "oklch(0.12 0.0130194 268.858)"  # --dwc-color-body-text
  # Borders
  border-color: "oklch(0.9 0.00104155 268.858)"  # --dwc-border-color
  border-color-emphasis: "oklch(0.708 0.00260388 268.858)"  # --dwc-border-color-emphasis
  # Overlay
  overlay-background: "oklch(0 0 0 / 0.16)"  # --dwc-overlay-background
typography:
  h1:
...
The values in this file are a resolved snapshot of the **light** theme at its default seeds. The real system is dynamic: change a seed hue or flip the mode and every color recalculates at runtime.
...
- `xs` `oklch(0.15 0.0173592 268.858 / 0.1) 0px 1px 2px -1px`
- `s` `oklch(0.15 0.0173592 268.858 / 0.04) 0px 3px 5px -2px, oklch(0.15 0.0173592 268.858 / 0.06) 0px 7px 14px -5px`
- `m` `oklch(0.15 0.0173592 268.858 / 0.03) 0px 4px 6px -2px, oklch(0.15 0.0173592 268.858 / 0.06) 0px 12px 16px -4px, oklch(0.15 0.0173592 268.858 / 0.02) 0px 1px 3px 0px`
- `l` `oklch(0.15 0.0173592 268.858 / 0.03) 0px 4px 6px -2px, oklch(0.15 0.0173592 268.858 / 0.05) 0px 12px 16px -4px, oklch(0.15 0.0173592 268.858 / 0.06) 0px 20px 25px -5px, oklch(0.15 0.0173592 268.858 / 0.02) 0px 1px 3px 0px`
- `xl` `oklch(0.15 0.0173592 268.858 / 0.03) 0px 4px 6px -2px, oklch(0.15 0.0173592 268.858 / 0.04) 0px 12px 16px -4px, oklch(0.15 0.0173592 268.858 / 0.05) 0px 20px 25px -5px, oklch(0.15 0.0173592 268.858 / 0.07) 0px 25px 50px -12px, oklch(0.15 0.0173592 268.858 / 0.02) 0px 1px 3px 0px`
- `2xl` `oklch(0.15 0.0173592 268.858 / 0.03) 0px 4px 6px -2px, oklch(0.15 0.0173592 268.858 / 0.04) 0px 12px 16px -4px, oklch(0.15 0.0173592 268.858 / 0.05) 0px 20px 25px -5px, oklch(0.15 0.0173592 268.858 / 0.06) 0px 25px 50px -12px, oklch(0.15 0.0173592 268.858 / 0.08) 0px 40px 80px -20px, oklch(0.15 0.0173592 268.858 / 0.02) 0px 1px 3px 0px`
