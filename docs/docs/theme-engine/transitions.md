...
Transition variables are used to provide consistent transitions throughout your app. They control the duration of animation effects.
...
?> Hover over the tracks to see each speed in action.

## Easing

The easing variables define a set of predefined transition-timing functions which can be used in your app to create smooth transitions and animations.
