...
?> **Note:** `rem` is a relative length unit. It is relative to the [font size](https://developer.mozilla.org/en-US/docs/Web/CSS/font-size) of the root element (`<html>`), which defaults to 16px in most browsers.
