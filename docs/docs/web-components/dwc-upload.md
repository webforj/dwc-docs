...
| ``files``                  | ``files``                    |                                                                                                                                                                                                                                                                        | &#x2718; | ``File[]``                                                                                                                                                                                                                                                                                                                                                                                                                                             | ``[]``                   |
| ``filters``                | ``filters``                  | Array of filters to show as button dropdown or in the files picker dialog.&nbsp;&nbsp;If ``fs`` attribute is true and the browser support the File System Access API, filters&nbsp;will appear in the System Files Picker dialog.                                      | &#x2718; | ``DwcUploadFilter[]``                                                                                                                                                                                                                                                                                                                                                                                                                                  |                          |
