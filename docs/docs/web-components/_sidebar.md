- <span class="sidebar-icon">
  ...
  - [dwc-format-datetime](web-components/dwc-format-datetime)
  - [dwc-format-number](web-components/dwc-format-number)
  - [dwc-format-text](web-components/dwc-format-text)
