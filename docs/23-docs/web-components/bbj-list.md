# bbj-list
![Documentation Type](https://img.shields.io/badge/Documentation-web--components-%23006aff) ![Tag Name](https://img.shields.io/badge/Component-bbj--list-%23006aff)  ![Encapsulation](https://img.shields.io/badge/Encapsulation-shadow-%23006aff)
...
| ``bbj-item-clicked``   | Fired when one of the items is clicked.        | ``{ index: number; item: BbjListItem; }`` |
| ``bbj-item-dbclicked`` | Fired when one of the items is double clicked. | ``{ index: number; item: BbjListItem; }`` |
| ``bbj-selected``       | Fired when a menu item is selected.            | ``BbjListEventPayload[]``                 |
...
| Name                                  | Description                                      |
| ------------------------------------- | ------------------------------------------------ |
| ``--bbj-list-background``             | The list's background color                      |
| ``--bbj-list-border-color``           | The list's border color                          |
| ``--bbj-list-color``                  | The list's color                                 |
| ``--bbj-list-focus-border-color``     | The list's border color when hovered             |
| ``--bbj-list-focus-ring``             | The focus ring of the list                       |
| ``--bbj-list-highlighted-background`` | The background of the highlighted (focused) item |
| ``--bbj-list-highlighted-color``      | The color of the highlighted(focused) item       |
| ``--bbj-list-label-color``            | The color of the label                           |
| ``--bbj-list-label-font-weight``      | The font weight of the label                     |
| ``--bbj-list-label-hover-color``      | The color of the label when hovered              |
| ``--bbj-list-padding``                | The list items padding                           |
| ``--bbj-list-selected-background``    | The background of the selected item              |
| ``--bbj-list-selected-color``         | The color of the selected item                   |
